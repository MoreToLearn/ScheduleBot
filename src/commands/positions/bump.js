module.exports = {
	...
	"execute": async (message, [id]) => {
		...
		fetch_msg.delete();
		message.guild.channels.cache.get(message.client.data.channel_id).send("THIS POSITION IS BEING BUMPED. If you do not have a student, feel free to claim", fetch_msg.embeds[0]);
