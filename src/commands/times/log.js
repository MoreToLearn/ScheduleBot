...
module.exports = {
	...
	"execute": async function (message) {
		...
		await message.channel.send(new PromptEmbed("What is your first and last name?", "Please use the same name in every time log"));
		...
		await message.channel.send(new PromptEmbed("What is the amount of hours you spent", "PLEASE GIVE ONLY THE AMOUNT OF HOURS IN NUMBER FORM. **YOU WILL PROVIDE MINUTES LATER**. Cannot be more than 4 at a time."));
		...
		await message.channel.send(new PromptEmbed("What is the amount of minutes you spent", "\nExample: `25`"));
		...
		await message.channel.send(new PromptEmbed("What date was this done?", "Please format as **MM-DD-YYYY**.\n`(Ex. 4-17-2020)`"));
		...
		await message.channel.send(new PromptEmbed("What did you spend your time doing/teaching?", "This can be as long as you wish.\nEx. `Taught child how to tie their shoes`"));
